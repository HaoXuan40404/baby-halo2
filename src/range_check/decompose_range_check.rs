...
use super::table3::RangeTableConfig;
...
#[derive(Debug, Clone)]
struct DecomposeConfig<F: PrimeField, const LOOKUP_NUM_BITS: usize, const LOOKUP_RANGE: usize> {
...
impl<F: PrimeField, const LOOKUP_NUM_BITS: usize> DecomposeConfig<F, LOOKUP_NUM_BITS, 10> {
